...
public class HocVienJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnUpdateDiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Up.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        jButton1.setText("In ra excel");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        jButton2.setText("In ra excel");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        XExcel a = new XExcel();
        try {
            a.exportTable(tblHocVien, new File("C:/Users/nguye/Desktop/hocVien.xls"));
//        this.exportExcel(tblHocVien)
            MsgBox.alert(null, "Lưu file học viên thành công.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         XExcel a = new XExcel();
        try {
            a.exportTable(tblNguoiHoc, new File("C:/Users/nguye/Desktop/nguoiHoc.xls"));
//        this.exportExcel(tblHocVien)
            MsgBox.alert(null, "Lưu file người học thành công.");
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(this,"Lỗi: \n"+ex);
        }
