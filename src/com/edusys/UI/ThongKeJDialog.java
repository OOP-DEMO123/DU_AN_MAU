...
public class ThongKeJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnBangDiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        btnBangDiem.setText("In ra excel");
        btnBangDiem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBangDiemActionPerformed(evt);
            }
        });
        jPanel1.add(btnBangDiem, java.awt.BorderLayout.PAGE_END);
        ...
        btnNguoiHoc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        btnNguoiHoc.setText("In ra excel");
        btnNguoiHoc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNguoiHocActionPerformed(evt);
            }
        });
        jPanel3.add(btnNguoiHoc, java.awt.BorderLayout.PAGE_END);
        ...
        btnChuyenDe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        btnChuyenDe.setText("In ra excel");
        btnChuyenDe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnChuyenDeActionPerformed(evt);
            }
        });
        jPanel2.add(btnChuyenDe, java.awt.BorderLayout.PAGE_END);
        ...
        btnDoanhThu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/Documents.png"))); // NOI18N
        btnDoanhThu.setText("In ra excel");
        btnDoanhThu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDoanhThuActionPerformed(evt);
            }
        });
        jPanel4.add(btnDoanhThu, java.awt.BorderLayout.PAGE_END);
    ...
    private void btnBangDiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBangDiemActionPerformed
        // TODO add your handling code here:
        //this.exportExcel(tblBangDiem);
        try {
            XExcel a = new XExcel();
            a.exportTable(tblBangDiem, new File("C:/Users/nguye/Desktop/bangDiem.xls"));
            MsgBox.alert(null, "Lưu file bảng điểm thành công.");
        } catch (Exception e) {
    ...
    private void btnNguoiHocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNguoiHocActionPerformed
        // TODO add your handling code here:
        //this.exportExcel(tblNguoiHoc);
        try {
            XExcel a = new XExcel();
            a.exportTable(tblNguoiHoc, new File("C:/Users/nguye/Desktop/DSnguoiHoc.xls"));
            MsgBox.alert(null, "Lưu file danh sách người học thành công.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Lỗi:\n" + e);
        }
    ...
    private void btnChuyenDeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChuyenDeActionPerformed
        ...
        try {
            XExcel a = new XExcel();
            a.exportTable(tblDiemChuyenDe, new File("C:/Users/nguye/Desktop/chuyenDe.xls"));
            MsgBox.alert(null, "Lưu file chuyên đề thành công.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Lỗi:\n" + e);
        }
    ...
    private void btnDoanhThuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoanhThuActionPerformed
        ...
        try {
            XExcel a = new XExcel();
            a.exportTable(tblDoanhThu, new File("C:/Users/nguye/Desktop/doanhThu.xls"));
            MsgBox.alert(null, "Lưu file doanh thu thành công.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Lỗi:\n" + e);
        }
